...
collector.options.folder_data = [getenv('OCT_DOCUMENTS') 'C:/Users/undergrad/Desktop/Publication_Dataset/']; % set this folder to the directory where you unzipped the dataset
